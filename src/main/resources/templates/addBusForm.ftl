...
<div class="center-global-container">
    <div class="addForm-container">
        ...
        <form id="addBusForm" class="addForm" action="/buses/add" method="post">
            ...
            <div class="text-field">
                ...
                <input class="text-field__input" type="text" id="registrationNumber" name="registrationNumber"
                       placeholder="AA1234ББ" maxlength="8" pattern="[А-Я]{2}\d{4}[А-Я]{2}" required>
            </div>
            <span class="fillInInstruction" id="registrationNumberError"></span>
            <div class="text-field">
