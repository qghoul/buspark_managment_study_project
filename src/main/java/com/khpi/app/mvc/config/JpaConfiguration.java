package com.khpi.app.mvc.config;
...
@Configuration
@ComponentScan(value = "com.khpi.app.mvc")
@EnableWebMvc
//@EntityScan(basePackages = "com.khpi.app.mvc.models")
@EnableJpaRepositories(basePackages = "com.khpi.app.mvc.repositories")
...
public class JpaConfiguration
{
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory()
    {
        ...
        emf.setPackagesToScan("com.khpi.app.mvc.models");  // 2. where models located
